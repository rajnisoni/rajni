...
if (isset($_POST['register'])) {
    ...
    $query = "INSERT INTO form (fname, user, email, phone, password, confirm, adhar, company, position, start, end, gender, temporary, permanent, description) VALUES ('$fname', '$uname', '$email', '$phone', '$password', '$confirm', '$adhar', '$company', '$position', '$start', '$end', '$gender', '$temporary', '$permanent', '$description')";
