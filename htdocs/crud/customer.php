        ...
        <div class="recent-grid">
            ...
            <div class="customers">
                    <div class="card">
                        <div class="card-header">
                            <h2>Feedback</h2>
                            <button onclick="location.href='customerFeedbackPage.html'">See all <span class="las la-arrow-right"></span></button>
                        ...
                        <div class="card-body">
                            <div class="customer">
                                ...
                                <div>
                                    <h4>Ravi Sahu</h4>
                                    <small>"Your work the past few weeks has been amazing! You really care about your work and you seem to really take the time to do it the best you can."</small>
                                </div>
                            </div>
